...
In the front-end, I utilize cutting-edge technologies such as React.js, Redux, and TypeScript, while leveraging Tailwind CSS for beautiful and user-friendly designs. On the backend, I work with Express.js and GraphQl to build APIs, and leverage SQL Server and MongoDB for data management.  
